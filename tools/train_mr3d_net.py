...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/opv2v_models/sr3d-net.yaml', help='specify the config for training')
    ...
    parser.add_argument('--extra_tag', type=str, default='sr3dnet_test_2', help='extra tag for this experiment')
    parser.add_argument('--device', type=int, default=0, help='device for non-distributed training')
    parser.add_argument('--eval_from_epoch', type=int, default=90, help='number of epochs from where evaluation starts during training')
