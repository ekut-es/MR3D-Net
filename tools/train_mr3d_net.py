...
def parse_config():
    ...
    parser.add_argument('--extra_tag', type=str, default='mr3dnet_release_test_3', help='extra tag for this experiment')
    parser.add_argument('--device', type=int, default=1, help='device for non-distributed training')
    parser.add_argument('--eval_from_epoch', type=int, default=0, help='number of epochs from where evaluation starts during training')
