...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = ['vfe']
        if model_cfg.get('COLLECTIVE_VFE', None) is not None:
            self.module_topology += ['collective_vfe']
    ...
    def build_collective_vfe(self, model_info_dict):
        if self.model_cfg.get('COLLECTIVE_VFE', None) is None:
            return None, model_info_dict

        vfe_module = vfe.__all__[self.model_cfg.COLLECTIVE_VFE.NAME](
            model_cfg=self.model_cfg.COLLECTIVE_VFE,
            num_point_features=model_info_dict['num_rawpoint_features'],
            point_cloud_range=model_info_dict['point_cloud_range'],
            voxel_size=model_info_dict['voxel_size'],
            grid_size=model_info_dict['grid_size'],
        ...
        model_info_dict['collective_num_point_features'] = vfe_module.get_output_feature_dim()
        model_info_dict['module_list'].append(vfe_module)
        return vfe_module, model_info_dict
    

    # def build_collective_backbone_3d(self, model_info_dict):
    #     backbone_3d_cfg = self.model_cfg.get('COLLECTIVE_BACKBONE_3D', None)
    #     if backbone_3d_cfg is None:
    #         return None, model_info_dict

    #     # Instantiation
    #     backbone_3d_module = backbones_3d.__all__[self.model_cfg.COLLECTIVE_BACKBONE_3D.NAME](
    #         model_cfg=self.model_cfg.COLLECTIVE_BACKBONE_3D,
    #         input_channels=model_info_dict['collective_num_point_features'],
    #         grid_size=model_info_dict['grid_size'],
    #         voxel_size=model_info_dict['voxel_size'],
    #         point_cloud_range=model_info_dict['point_cloud_range']
    #     )
