...
from .collective_vfe import CollectiveMeanVFE
from .collective_vfe import CollectiveCenterVFE
...
__all__ = {
    ...
    'CollectiveMeanVFE': CollectiveMeanVFE,
    'CollectiveCenterVFE': CollectiveCenterVFE,
}
