...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            CppExtension(
                name='pcdet.ops.opv2v_tools.opv2v_transformations',
                sources=["pcdet/ops/opv2v_tools/src/transformations.cpp", "pcdet/ops/opv2v_tools/src/tensor.cpp"],
                define_macros=[("BUILD_MODULE", None)],
                extra_compile_args=['-O3'],
            ),
            CppExtension(
                name='pcdet.ops.opv2v_tools.opv2v_evaluation',
                sources=["pcdet/ops/opv2v_tools/src/evaluation.cpp", "pcdet/ops/opv2v_tools/src/utils.cpp"],
                define_macros=[("BUILD_MODULE", None)],
                extra_compile_args=['-O3'],
            ),
            make_cuda_ext(
